            ...
            <main className="relative max-w-full px-7">
                <section className="pb-24 pt-16 text-center">
                    ...
                    <p className="mx-auto mt-6 max-w-[560px] text-[19px] leading-relaxed">
                        ...
                        game franchise ever made, Destiny. Every track is
                        painstakingly tagged, noted, and catalogued with all of
                        its marginalia. Each motif and idea found and brought
                        into the light from the dark. An archive of over a
                        decade's worth of joy, grief, sorrow, anger, fear,
                        knowledge, and hope.
                    </p>
