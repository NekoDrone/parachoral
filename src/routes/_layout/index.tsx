    ...
    return (
        <PageWrapper variant="full">
            <section className="pb-24 pt-16 text-center">
                ...
                <p className="mt-5 font-sans text-[11px] font-light uppercase tracking-[0.42em] indent-[0.42em] text-accent">
                    A songbook of the Destiny universe
                </p>
                <p className="mx-auto mt-6 max-w-[560px] text-[19px] leading-relaxed">
                    A celebration and extolment of the music in the best game
                    franchise ever made, Destiny. Every track is painstakingly
                    tagged, noted, and catalogued with all of its marginalia.
                    Each motif and idea found and brought into the light from
                    the dark. An archive of over a decade's worth of joy, grief,
